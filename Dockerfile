...
WORKDIR /go/src/github.com/lasthyphen/archiver
...
COPY --from=builder /go/src/github.com/lasthyphen/archiver/docker/config.json /opt/config.json
COPY --from=builder /go/src/github.com/lasthyphen/archiver/services/db/migrations /opt/migrations
